...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "MFD12345".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["llrd.des8.com"];
pub const RS_PUB_KEY: &str = "WdydGwxF4UgP6VrY3FVyA7BkNdXLmQZCk+T2uy7F54A=";
